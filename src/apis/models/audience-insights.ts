...
export const AudienceInsightsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        insightsGetAudiencesOverlappingAudiences: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, audienceId: string, adType: 'DSP' | 'SD', advertiserId?: string, minimumAudienceSize?: number, maximumAudienceSize?: number, minimumOverlapAffinity?: number, maximumOverlapAffinity?: number, audienceCategory?: Array<string>, maxResults?: number, nextToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AudienceInsightsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async insightsGetAudiencesOverlappingAudiences(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, audienceId: string, adType: 'DSP' | 'SD', advertiserId?: string, minimumAudienceSize?: number, maximumAudienceSize?: number, minimumOverlapAffinity?: number, maximumOverlapAffinity?: number, audienceCategory?: Array<string>, maxResults?: number, nextToken?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200>> {
...
export class AudienceInsightsApi extends BaseAPI {
     ...
     */
    public insightsGetAudiencesOverlappingAudiences(requestParameters: AudienceInsightsApiInsightsGetAudiencesOverlappingAudiencesRequest, options?: AxiosRequestConfig) {
