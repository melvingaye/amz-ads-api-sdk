...
export const ProductSelectorApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        productMetadata: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, productMetadataRequest: ProductMetadataRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ProductSelectorApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async productMetadata(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, productMetadataRequest: ProductMetadataRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductMetadataResponse>> {
