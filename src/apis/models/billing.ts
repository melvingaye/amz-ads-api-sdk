...
export const BillingNotificationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        bulkGetBillingNotifications: async (bulkGetBillingNotificationsRequestBody: BulkGetBillingNotificationsRequestBody, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const BillingNotificationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async bulkGetBillingNotifications(bulkGetBillingNotificationsRequestBody: BulkGetBillingNotificationsRequestBody, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BulkGetBillingNotificationsResponse>> {
...
export class BillingNotificationsApi extends BaseAPI {
     ...
     */
    public bulkGetBillingNotifications(requestParameters: BillingNotificationsApiBulkGetBillingNotificationsRequest, options?: AxiosRequestConfig) {
...
export const BillingStatusApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        bulkGetBillingStatus: async (bulkGetBillingStatusesRequestBody: BulkGetBillingStatusesRequestBody, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const BillingStatusApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async bulkGetBillingStatus(bulkGetBillingStatusesRequestBody: BulkGetBillingStatusesRequestBody, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BulkGetBillingStatusResponse>> {
...
export class BillingStatusApi extends BaseAPI {
     ...
     */
    public bulkGetBillingStatus(requestParameters: BillingStatusApiBulkGetBillingStatusRequest, options?: AxiosRequestConfig) {
...
export const InvoiceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAdvertiserInvoices: async (invoiceStatuses?: Array<'ISSUED' | 'PAID_IN_PART' | 'PAID_IN_FULL' | 'WRITTEN_OFF'>, count?: number, cursor?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const InvoiceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAdvertiserInvoices(invoiceStatuses?: Array<'ISSUED' | 'PAID_IN_PART' | 'PAID_IN_FULL' | 'WRITTEN_OFF'>, count?: number, cursor?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200>> {
...
export class InvoiceApi extends BaseAPI {
     ...
     * @memberof InvoiceApi
     */
    public getAdvertiserInvoices(requestParameters: InvoiceApiGetAdvertiserInvoicesRequest = {}, options?: AxiosRequestConfig) {
     ...
     * @memberof InvoiceApi
     */
    public getInvoice(requestParameters: InvoiceApiGetInvoiceRequest, options?: AxiosRequestConfig) {
