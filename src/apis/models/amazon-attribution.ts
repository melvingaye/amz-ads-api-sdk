...
export interface Publisher {
    /**
     * Set to \'true\' if the publisher supports macros.
     * @type {boolean}
     * @memberof Publisher
     */
...
export interface ReportRequestBody {
    /**
     * The type of report. Either `PERFORMANCE` or `PRODUCTS`. It is an optional parameter. If not used in request body, default reportType is `PERFORMANCE`. Each report type is aggregated at different levels. See below table for list of dimensions available within each report type. |reportType  |Dimension| |--------|-----------| |PERFORMANCE|campaignId, adgroupId, creativeid| |PRODUCTS|campaignId, adgroupId|
     * @type {string}
    ...
    'count'?: number;
    /**
     * A comma-delimited list of metrics to include in the report. Each report type returns a unique set of metrics. View the list of available metrics by report type below. |Metrics for reportType`PERFORMANCE`| |-------------------| |Metric  |Description| |--------|-----------| |Click-throughs|Total ad clicks.| |attributedDetailPageViewsClicks14d|The number of promoted detail page view conversions attributed to ad click-throughs within 14 days.| |attributedAddToCartClicks14d|The number of promoted add to cart conversions attributed to ad click-throughs within 14 days.| |attributedPurchases14d|The number of promoted purchases attributed to ad click-throughs within 14 days.| |unitsSold14d|The number of promoted units sold attributed to ad click-throughs within 14 days.| |attributedSales14d|Aggregate value of promoted attributed sales occurring within 14 days of an attribution event in local currency.| |attributedTotalDetailPageViewsClicks14d|The number of total detail page view conversions attributed to ad click-throughs within 14 days, including brand halo.| |attributedTotalAddToCartClicks14d|The number of total add to cart conversions attributed to ad click-throughs within 14 days, including brand halo.| |attributedTotalPurchases14d|The number of total purchases attributed to ad click-throughs within 14 days, including brand halo.| |totalUnitsSold14d|The number of total units sold attributed to ad click-throughs within 14 days, including brand halo.| |totalAttributedSales14d|Aggregate value of total attributed sales occurring within 14 days of an attribution event in local currency, including brand halo.|  |Metrics for reportType`PRODUCTS`| |-------------------| |Metric  |Description| |--------|-----------| |attributedDetailPageViewsClicks14d|The number of promoted detail page view conversions attributed to ad click-throughs within 14 days.| |attributedAddToCartClicks14d|The number of promoted add to cart conversions attributed to ad click-throughs within 14 days.| |attributedPurchases14d|The number of promoted purchases attributed to ad click-throughs within 14 days.| |unitsSold14d|The number of promoted units sold attributed to ad click-throughs within 14 days.| |attributedSales14d|Aggregate value of promoted attributed sales occurring within 14 days of an attribution event in local currency.| |brandHaloDetailPageViewsClicks14d|The number of Brand halo detail page view conversions attributed to ad click-throughs within 14 days.| |brandHaloAttributedAddToCartClicks14d|The number of Brand halo add to cart conversions attributed to ad click-throughs within 14 days.| |brandHaloAttributedPurchases14d|The number of Brand halo purchases attributed to ad click-throughs within 14 days.| |brandHaloUnitsSold14d|The number of Brand halo units sold attributed to ad click-throughs within 14 days.| |brandHaloAttributedSales14d|Aggregate value of Brand halo attributed sales occurring within 14 days of an attribution event in local currency.| |attributedNewToBrandPurchases14d|The number of promoted purchases made for the first time over a one-year lookback window by customers on Amazon, attributed to ad click-throughs within 14 days.| |attributedNewToBrandUnitsSold14d|The number of promoted units sold made for the first time over a one-year lookback window by customers on Amazon, attributed to ad click-throughs within 14 days.| |attributedNewToBrandSales14d|The aggregate value of promoted sales made for the first time over a one-year lookback window by customers on Amazon, attributed to ad click-throughs within 14 days.| |brandHaloNewToBrandPurchases14d|The number of Brand halo purchases made for the first time over a one-year lookback window by customers on Amazon, attributed to ad click-throughs within 14 days.| |brandHaloNewToBrandUnitsSold14d|The number of Brand halo units sold made for the first time over a one-year lookback window by customers on Amazon, attributed to ad click-throughs within 14 days.| |brandHaloNewToBrandSales14d|The aggregate value of Brand halo sales made for the first time over a one-year lookback window by customers on Amazon, attributed to ad click-throughs within 14 days.|
     * @type {string}
     * @memberof ReportRequestBody
     */
    'metrics'?: string;
...
export const AdvertisersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAdvertisersByProfile: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AdvertisersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAdvertisersByProfile(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AdvertiserResponse>> {
...
export class AdvertisersApi extends BaseAPI {
     ...
     */
    public getAdvertisersByProfile(requestParameters: AdvertisersApiGetAdvertisersByProfileRequest, options?: AxiosRequestConfig) {
...
export const AttributionTagsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getPublisherAttributionTagTemplate: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, publisherIds: Array<string>, advertiserIds?: Array<number>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getPublisherMacroAttributionTag: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, publisherIds: Array<string>, advertiserIds?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const AttributionTagsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getPublisherAttributionTagTemplate(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, publisherIds: Array<string>, advertiserIds?: Array<number>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AttributionTagResponse>> {
         ...
         * @throws {RequiredError}
         */
        async getPublisherMacroAttributionTag(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, publisherIds: Array<string>, advertiserIds?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AttributionTagResponse>> {
...
export class AttributionTagsApi extends BaseAPI {
     ...
     */
    public getPublisherAttributionTagTemplate(requestParameters: AttributionTagsApiGetPublisherAttributionTagTemplateRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof AttributionTagsApi
     */
    public getPublisherMacroAttributionTag(requestParameters: AttributionTagsApiGetPublisherMacroAttributionTagRequest, options?: AxiosRequestConfig) {
...
export const PublishersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Note that the \'macroEnabled\' field is set to \'true\' for Publishers that support macro tags.
         ...
         * @throws {RequiredError}
         */
        getPublishers: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const PublishersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getPublishers(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PublishersResponse>> {
...
export class PublishersApi extends BaseAPI {
     ...
     */
    public getPublishers(requestParameters: PublishersApiGetPublishersRequest, options?: AxiosRequestConfig) {
...
export const ReportsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAttributionTagsByCampaign: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, reportRequestBody: ReportRequestBody, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const ReportsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAttributionTagsByCampaign(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, reportRequestBody: ReportRequestBody, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReportResponse>> {
...
export class ReportsApi extends BaseAPI {
     ...
     * @memberof ReportsApi
     */
    public getAttributionTagsByCampaign(requestParameters: ReportsApiGetAttributionTagsByCampaignRequest, options?: AxiosRequestConfig) {
