...
export const CreativeAssetsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAsset: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, assetId: string, version?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getUploadLocation: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, inlineObject1: InlineObject1, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        registerAsset: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, inlineObject: InlineObject, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        searchAssets: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, caSearchRequestCommon: CaSearchRequestCommon, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const CreativeAssetsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAsset(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, assetId: string, version?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200>> {
         ...
         * @throws {RequiredError}
         */
        async getUploadLocation(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, inlineObject1: InlineObject1, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2002>> {
         ...
         * @throws {RequiredError}
         */
        async registerAsset(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, inlineObject: InlineObject, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2001>> {
         ...
         * @throws {RequiredError}
         */
        async searchAssets(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, caSearchRequestCommon: CaSearchRequestCommon, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2003>> {
...
export class CreativeAssetsApi extends BaseAPI {
     ...
     */
    public getAsset(requestParameters: CreativeAssetsApiGetAssetRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CreativeAssetsApi
     */
    public getUploadLocation(requestParameters: CreativeAssetsApiGetUploadLocationRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CreativeAssetsApi
     */
    public registerAsset(requestParameters: CreativeAssetsApiRegisterAssetRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CreativeAssetsApi
     */
    public searchAssets(requestParameters: CreativeAssetsApiSearchAssetsRequest, options?: AxiosRequestConfig) {
