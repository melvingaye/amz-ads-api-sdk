...
export interface ReportRequest {
    ...
    'tactic'?: TacticReport;
    /**
     * A comma-separated list of the metrics to be included in the report. The following tables summarize report metrics which can be requested via the reports interface. Different report types can use different metrics.   Notes:  1. \'asins\' report, also known as Purchased Products report, are only available for seller brand owners. 2. New-to-brand metrics are not available to book vendors. 3. Our recently added DPV metrics (attributedDetailPageView14d, viewAttributedDetailPageView14d) are currently available within a SLA of 3 days.  Pro Tip: You can use the new-to-brand (NTB) metrics to calculate how efficient your sd campaigns are at driving new shoppers;  1. Percentage of NTB Orders = AttributedOrdersNewToBrand14d / attributedConversions14d  2. Percentage NTB Sales = attributedSalesNewToBrand14d / attributedSales14d  3. Percentage NTB Units = attributedUnitsOrderedNewToBrand14d / attributedUnitsOrdered14d  4. NTB Order Rate = attributedOrdersNewToBrand14 / impressions    |Report Type |Metric |Tactic |Description| |------------|-------|-------|-----------| |campaigns&nbsp;|campaignName&nbsp;|T00020,T00030,remarketing&nbsp;|The name of the campaign.| |campaigns&nbsp;|campaignId&nbsp;|T00020,T00030,remarketing&nbsp;|The identifier of the campaign.| |campaigns&nbsp;|impressions&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of ad impressions.| |campaigns&nbsp;|clicks&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of ad clicks associated with the campaign.| |campaigns&nbsp;|cost&nbsp;|T00020,T00030,remarketing&nbsp;|The total cost of all ad clicks for the campaign. Divide `cost` by `clicks` to calculate average cost per click (CPC).| |campaigns&nbsp;|currency&nbsp;|T00020,T00030,remarketing&nbsp;|The currency code associated with the campaign.| |campaigns&nbsp;|attributedConversions1d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 24 hours of ad click.| |campaigns&nbsp;|attributedConversions7d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 7 days of ad click.| |campaigns&nbsp;|attributedConversions14d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 14 days of ad click.| |campaigns&nbsp;|attributedConversions30d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 30 days of ad click.| |campaigns&nbsp;|attributedConversions1dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 24 hours of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |campaigns&nbsp;|attributedConversions7dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 7 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |campaigns&nbsp;|attributedConversions14dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 14 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |campaigns&nbsp;|attributedConversions30dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 30 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |campaigns&nbsp;|attributedUnitsOrdered1d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 24 hours of ad click.| |campaigns&nbsp;|attributedUnitsOrdered7d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 7 days of ad click.| |campaigns&nbsp;|attributedUnitsOrdered14d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 14 days of ad click.| |campaigns&nbsp;|attributedUnitsOrdered30d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 30 days of ad click.| |campaigns&nbsp;|attributedSales1d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 24 hours of ad click.| |campaigns&nbsp;|attributedSales7d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 7 days of ad click.| |campaigns&nbsp;|attributedSales14d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 14 days of ad click.| |campaigns&nbsp;|attributedSales30d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 30 days of ad click.| |campaigns&nbsp;|attributedSales1dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 24 hours of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |campaigns&nbsp;|attributedSales7dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 7 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |campaigns&nbsp;|attributedSales14dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 14 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |campaigns&nbsp;|attributedSales30dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 30 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |campaigns&nbsp;|attributedOrdersNewToBrand14d&nbsp;|T00020,T00030&nbsp;|The number of first-time orders for products within the brand over a one-year lookback window.| |campaigns&nbsp;|attributedSalesNewToBrand14d&nbsp;|T00020,T00030&nbsp;|The total sales of new-to-brand orders for products within the brand over a one-year lookback window.| |campaigns&nbsp;|attributedUnitsOrderedNewToBrand14d&nbsp;|T00020,T00030&nbsp;| The number of units from first-time orders for products within the brand over a one-year lookback window.| |campaigns&nbsp;|costType&nbsp;|T00020,T00030&nbsp;|[NEW] Determines how the campaign will bid and charge.| |campaigns&nbsp;|viewImpressions&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of ad viewable impressions.| |campaigns&nbsp;|viewAttributedConversions14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed conversion events occurring within 14 days of ad click or view.| |campaigns&nbsp;|viewAttributedSales14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed sales occurring within 14 days of ad click or view.| |campaigns&nbsp;|viewAttributedUnitsOrdered14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed units ordered occurring within 14 days of ad click or view.| |campaigns&nbsp;|attributedDetailPageView14d&nbsp;|T00020,T00030&nbsp;| [NEW] Total number of attributed detail-page view occurring within 14 days of ad click.| |campaigns&nbsp;|viewAttributedDetailPageView14d&nbsp;|T00020,T00030&nbsp;| [NEW for \'vCPM\' campaigns] Total number of attributed detail-page views occurring within 14 days of ad click or view.| |adGroups&nbsp;|campaignName&nbsp;|T00020,T00030,remarketing&nbsp;|The name of the campaign.| |adGroups&nbsp;|campaignId&nbsp;|T00020,T00030,remarketing&nbsp;|The identifier of the campaign.| |adGroups&nbsp;|adGroupName&nbsp;|T00020,T00030,remarketing&nbsp;|The name of the ad group.| |adGroups&nbsp;|adGroupId&nbsp;|T00020,T00030,remarketing&nbsp;|The identifier of the ad group.| |adGroups&nbsp;|impressions&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of ad impressions.| |adGroups&nbsp;|clicks&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of ad clicks associated with the campaign.| |adGroups&nbsp;|cost&nbsp;|T00020,T00030,remarketing&nbsp;|The total cost of all ad clicks for the campaign. Divide `cost` by `clicks` to calculate average cost per click (CPC).| |adGroups&nbsp;|currency&nbsp;|T00020,T00030,remarketing&nbsp;|The currency code associated with the campaign.| |adGroups&nbsp;|attributedConversions1d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 24 hours of ad click.| |adGroups&nbsp;|attributedConversions7d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 7 days of ad click.| |adGroups&nbsp;|attributedConversions14d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 14 days of ad click.| |adGroups&nbsp;|attributedConversions30d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 30 days of ad click.| |adGroups&nbsp;|attributedConversions1dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 24 hours of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |adGroups&nbsp;|attributedConversions7dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 7 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |adGroups&nbsp;|attributedConversions14dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 14 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |adGroups&nbsp;|attributedConversions30dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 30 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |adGroups&nbsp;|attributedUnitsOrdered1d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 24 hours of ad click.| |adGroups&nbsp;|attributedUnitsOrdered7d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 7 days of ad click.| |adGroups&nbsp;|attributedUnitsOrdered14d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 14 days of ad click.| |adGroups&nbsp;|attributedUnitsOrdered30d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 30 days of ad click.| |adGroups&nbsp;|attributedSales1d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 24 hours of ad click.| |adGroups&nbsp;|attributedSales7d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 7 days of ad click.| |adGroups&nbsp;|attributedSales14d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 14 days of ad click.| |adGroups&nbsp;|attributedSales30d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 30 days of ad click.| |adGroups&nbsp;|attributedSales1dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 24 hours of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |adGroups&nbsp;|attributedSales7dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 7 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |adGroups&nbsp;|attributedSales14dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 14 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |adGroups&nbsp;|attributedSales30dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 30 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |adGroups&nbsp;|attributedOrdersNewToBrand14d&nbsp;|T00020,T00030&nbsp;|The number of first-time orders for products within the brand over a one-year lookback window.| |adGroups&nbsp;|attributedSalesNewToBrand14d&nbsp;|T00020,T00030&nbsp;| The total sales of new-to-brand orders for products within the brand over a one-year lookback window.| |adGroups&nbsp;|attributedUnitsOrderedNewToBrand14d&nbsp;|T00020,T00030&nbsp;|The number of units from first-time orders for products within the brand over a one-year lookback window.| |adGroups&nbsp;|bidOptimization&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Bid Optimization for the Adgroup. Default behavior is to optimize for \'clicks\'.| |adGroups&nbsp;|viewImpressions&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of ad viewable impressions.| |adGroups&nbsp;|viewAttributedConversions14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed conversion events occurring within 14 days of ad click or view.| |adGroups&nbsp;|viewAttributedSales14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed sales occurring within 14 days of ad click or view.| |adGroups&nbsp;|viewAttributedUnitsOrdered14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed units ordered occurring within 14 days of ad click or view.| |adGroups&nbsp;|attributedDetailPageView14d&nbsp;|T00020,T00030&nbsp;| [NEW] Total number of attributed detail-page view occurring within 14 days of ad click.| |adGroups&nbsp;|viewAttributedDetailPageView14d&nbsp;|T00020,T00030&nbsp;| [NEW for \'vCPM\' campaigns] Total number of attributed detail-page views occurring within 14 days of ad click or view.| |productAds&nbsp;|campaignName&nbsp;|T00020,T00030,remarketing&nbsp;|The name of the campaign.| |productAds&nbsp;|campaignId&nbsp;|T00020,T00030,remarketing&nbsp;|The identifier of the campaign.| |productAds&nbsp;|adGroupName&nbsp;|T00020,T00030,remarketing&nbsp;|The name of the ad group.| |productAds&nbsp;|adGroupId&nbsp;|T00020,T00030,remarketing&nbsp;|The identifier of the ad group.| |productAds&nbsp;|asin&nbsp;|T00020,T00030,remarketing&nbsp;|The ASIN of the product.| |productAds&nbsp;|sku&nbsp;|T00020,T00030,remarketing&nbsp;|The SKU of the product.| |productAds&nbsp;|adId&nbsp;|T00020,T00030,remarketing&nbsp;|The unique numerical ID of the ad.| |productAds&nbsp;|impressions&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of ad impressions.| |productAds&nbsp;|clicks&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of ad clicks associated with the campaign.| |productAds&nbsp;|cost&nbsp;|T00020,T00030,remarketing&nbsp;|The total cost of all ad clicks for the campaign. Divide `cost` by `clicks` to calculate average cost per click (CPC).| |productAds&nbsp;|currency&nbsp;|T00020,T00030,remarketing&nbsp;|The currency code associated with the campaign.| |productAds&nbsp;|attributedConversions1d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 24 hours of ad click.| |productAds&nbsp;|attributedConversions7d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 7 days of ad click.| |productAds&nbsp;|attributedConversions14d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 14 days of ad click.| |productAds&nbsp;|attributedConversions30d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 30 days of ad click.| |productAds&nbsp;|attributedConversions1dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 24 hours of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |productAds&nbsp;|attributedConversions7dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 7 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |productAds&nbsp;|attributedConversions14dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 14 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |productAds&nbsp;|attributedConversions30dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed conversion events occurring within 30 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |productAds&nbsp;|attributedUnitsOrdered1d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 24 hours of ad click.| |productAds&nbsp;|attributedUnitsOrdered7d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 7 days of ad click.| |productAds&nbsp;|attributedUnitsOrdered14d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 14 days of ad click.| |productAds&nbsp;|attributedUnitsOrdered30d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed units ordered within 30 days of ad click.| |productAds&nbsp;|attributedSales1d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 24 hours of ad click.| |productAds&nbsp;|attributedSales7d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 7 days of ad click.| |productAds&nbsp;|attributedSales14d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 14 days of ad click.| |productAds&nbsp;|attributedSales30d&nbsp;|T00020,T00030,remarketing&nbsp;|Total number of attributed sales occurring within 30 days of ad click.| |productAds&nbsp;|attributedSales1dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 24 hours of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |productAds&nbsp;|attributedSales7dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 7 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |productAds&nbsp;|attributedSales14dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 14 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |productAds&nbsp;|attributedSales30dSameSKU&nbsp;|T00020,T00030,remarketing&nbsp;|Aggregate value of all attributed sales occurring within 30 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |productAds&nbsp;|attributedOrdersNewToBrand14d&nbsp;|T00020,T00030&nbsp;| The number of first-time orders for products within the brand over a one-year lookback window.| |productAds&nbsp;|attributedSalesNewToBrand14d&nbsp;|T00020,T00030&nbsp;| The total sales of new-to-brand orders for products within the brand over a one-year lookback window.| |productAds&nbsp;|attributedUnitsOrderedNewToBrand14d&nbsp;|T00020,T00030&nbsp;| The number of units from first-time orders for products within the brand over a one-year lookback window.| |productAds&nbsp;|viewImpressions&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of ad viewable impressions.| |productAds&nbsp;|viewAttributedConversions14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed conversion events occurring within 14 days of ad click or view.| |productAds&nbsp;|viewAttributedSales14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed sales occurring within 14 days of ad click or view.| |productAds&nbsp;|viewAttributedUnitsOrdered14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed units ordered occurring within 14 days of ad click or view.| |productAds&nbsp;|attributedDetailPageView14d&nbsp;|T00020,T00030&nbsp;| [NEW] Total number of attributed detail-page view occurring within 14 days of ad click.| |productAds&nbsp;|viewAttributedDetailPageView14d&nbsp;|T00020,T00030&nbsp;| [NEW for \'vCPM\' campaigns] Total number of attributed detail-page views occurring within 14 days of ad click or view.| |targets&nbsp;|campaignName&nbsp;|T00020,T00030&nbsp;|The name of the campaign.| |targets&nbsp;|campaignId&nbsp;|T00020,T00030&nbsp;|The identifier of the campaign.| |targets&nbsp;|adGroupName&nbsp;|T00020,T00030&nbsp;|The name of the ad group.| |targets&nbsp;|adGroupId&nbsp;|T00020,T00030&nbsp;|The identifier of the ad group.| |targets&nbsp;|targetId&nbsp;|T00020,T00030&nbsp;|The identifier of the targeting expression used in a bid.| |targets&nbsp;|targetingExpression&nbsp;|T00020,T00030&nbsp;|The string representation of your expression object in targeting clauses.| |targets&nbsp;|targetingText&nbsp;|T00020,T00030&nbsp;|The resolved string representation of your expression object in targeting clauses.| |targets&nbsp;|targetingType&nbsp;|T00020,T00030&nbsp;|The type of match for the targeting expression used in bid. For manually created expressions, this value is `TARGETING_EXPRESSION`. For auto-targeting expressions this value is `TARGETING_EXPRESSION_PREDEFINED`.| |targets&nbsp;|impressions&nbsp;|T00020,T00030&nbsp;|Total number of ad impressions.| |targets&nbsp;|clicks&nbsp;|T00020,T00030&nbsp;|Total number of ad clicks associated with the campaign.| |targets&nbsp;|cost&nbsp;|T00020,T00030&nbsp;|The total cost of all ad clicks for the campaign. Divide `cost` by `clicks` to calculate average cost per click (CPC).| |targets&nbsp;|currency&nbsp;|T00020,T00030&nbsp;|The currency code associated with the campaign.| |targets&nbsp;|attributedConversions1d&nbsp;|T00020,T00030&nbsp;|Total number of attributed conversion events occurring within 24 hours of ad click.| |targets&nbsp;|attributedConversions7d&nbsp;|T00020,T00030&nbsp;|Total number of attributed conversion events occurring within 7 days of ad click.| |targets&nbsp;|attributedConversions14d&nbsp;|T00020,T00030&nbsp;|Total number of attributed conversion events occurring within 14 days of ad click.| |targets&nbsp;|attributedConversions30d&nbsp;|T00020,T00030&nbsp;|Total number of attributed conversion events occurring within 30 days of ad click.| |targets&nbsp;|attributedConversions1dSameSKU&nbsp;|T00020,T00030&nbsp;|Total number of attributed conversion events occurring within 24 hours of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |targets&nbsp;|attributedConversions7dSameSKU&nbsp;|T00020,T00030&nbsp;|Total number of attributed conversion events occurring within 7 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |targets&nbsp;|attributedConversions14dSameSKU&nbsp;|T00020,T00030&nbsp;|Total number of attributed conversion events occurring within 14 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |targets&nbsp;|attributedConversions30dSameSKU&nbsp;|T00020,T00030&nbsp;|Total number of attributed conversion events occurring within 30 days of ad click, where the SKU of the product advertised and the SKU of the conversion event are equivalent.| |targets&nbsp;|attributedUnitsOrdered1d&nbsp;|T00020,T00030&nbsp;|Total number of attributed units ordered within 24 hours of ad click.| |targets&nbsp;|attributedUnitsOrdered7d&nbsp;|T00020,T00030&nbsp;|Total number of attributed units ordered within 7 days of ad click.| |targets&nbsp;|attributedUnitsOrdered14d&nbsp;|T00020,T00030&nbsp;|Total number of attributed units ordered within 14 days of ad click.| |targets&nbsp;|attributedUnitsOrdered30d&nbsp;|T00020,T00030&nbsp;|Total number of attributed units ordered within 30 days of ad click.| |targets&nbsp;|attributedSales1d&nbsp;|T00020,T00030&nbsp;|Total number of attributed sales occurring within 24 hours of ad click.| |targets&nbsp;|attributedSales7d&nbsp;|T00020,T00030&nbsp;|Total number of attributed sales occurring within 7 days of ad click.| |targets&nbsp;|attributedSales14d&nbsp;|T00020,T00030&nbsp;|Total number of attributed sales occurring within 14 days of ad click.| |targets&nbsp;|attributedSales30d&nbsp;|T00020,T00030&nbsp;|Total number of attributed sales occurring within 30 days of ad click.| |targets&nbsp;|attributedSales1dSameSKU&nbsp;|T00020,T00030&nbsp;|Aggregate value of all attributed sales occurring within 24 hours of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |targets&nbsp;|attributedSales7dSameSKU&nbsp;|T00020,T00030&nbsp;|Aggregate value of all attributed sales occurring within 7 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |targets&nbsp;|attributedSales14dSameSKU&nbsp;|T00020,T00030&nbsp;|Aggregate value of all attributed sales occurring within 14 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |targets&nbsp;|attributedSales30dSameSKU&nbsp;|T00020,T00030&nbsp;|Aggregate value of all attributed sales occurring within 30 days of ad click, where the SKU of the product advertised and the SKU of the purchased item are equivalent.| |targets&nbsp;|attributedOrdersNewToBrand14d&nbsp;|T00020,T00030&nbsp;|The number of first-time orders for products within the brand over a one-year lookback window.| |targets&nbsp;|attributedSalesNewToBrand14d&nbsp;|T00020,T00030&nbsp;|The total sales of new-to-brand orders for products within the brand over a one-year lookback window.| |targets&nbsp;|attributedUnitsOrderedNewToBrand14d&nbsp;|T00020,T00030&nbsp;|The number of units from first-time orders for products within the brand over a one-year lookback window.| |targets&nbsp;|viewImpressions&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of ad viewable impressions.| |targets&nbsp;|viewAttributedConversions14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed conversion events occurring within 14 days of ad click or view.| |targets&nbsp;|viewAttributedSales14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed sales occurring within 14 days of ad click or view.| |targets&nbsp;|viewAttributedUnitsOrdered14d&nbsp;|T00020,T00030&nbsp;|[NEW for \'vCPM\' campaigns] Total number of attributed units ordered occurring within 14 days of ad click or view.| |targets&nbsp;|attributedDetailPageView14d&nbsp;|T00020,T00030&nbsp;| [NEW] Total number of attributed detail-page view occurring within 14 days of ad click.| |targets&nbsp;|viewAttributedDetailPageView14d&nbsp;|T00020,T00030&nbsp;| [NEW for \'vCPM\' campaigns] Total number of attributed detail-page views occurring within 14 days of ad click or view.| |asins&nbsp;|campaignName&nbsp;|T00020,T00030&nbsp;|The name of the campaign.| |asins&nbsp;|campaignId&nbsp;|T00020,T00030&nbsp;|The identifier of the campaign.| |asins&nbsp;|adGroupName&nbsp;|T00020,T00030&nbsp;|The name of the ad group.| |asins&nbsp;|adGroupId&nbsp;|T00020,T00030&nbsp;|The identifier of the ad group.| |asins&nbsp;|asin&nbsp;|T00020,T00030&nbsp;|The ASIN of the product.| |asins&nbsp;|otherAsin&nbsp;|T00020,T00030&nbsp;|The ASIN of the product other than the one advertised| |asins&nbsp;|sku&nbsp;|T00020,T00030&nbsp;|The SKU of the product.| |asins&nbsp;|currency&nbsp;|T00020,T00030&nbsp;|The currency code associated with the campaign.| |asins&nbsp;|attributedUnitsOrdered1dOtherSKU&nbsp;|T00020,T00030&nbsp;|Number of other ASIN (SKU) units sold. 1 day. | |asins&nbsp;|attributedUnitsOrdered7dOtherSKU&nbsp;|T00020,T00030&nbsp;|Number of other ASIN (SKU) units sold. 7 days. | |asins&nbsp;|attributedUnitsOrdered14dOtherSKU&nbsp;|T00020,T00030&nbsp;|Number of other ASIN (SKU) units sold. 14 days. | |asins&nbsp;|attributedUnitsOrdered30dOtherSKU&nbsp;|T00020,T00030&nbsp;|Number of other ASIN (SKU) units sold. 30 days. | |asins&nbsp;|attributedSales1dOtherSKU&nbsp;|T00020,T00030&nbsp;|Sales for another ASIN (SKU). 1 day. | |asins&nbsp;|attributedSales7dOtherSKU&nbsp;|T00020,T00030&nbsp;|Sales for another ASIN (SKU). 7 days. | |asins&nbsp;|attributedSales14dOtherSKU&nbsp;|T00020,T00030&nbsp;|Sales for another ASIN (sku). 14 days. | |asins&nbsp;|attributedSales30dOtherSKU&nbsp;|T00020,T00030&nbsp;|Sales for another ASIN (sku). 30 days. | |campaigns&nbsp;|campaignName&nbsp;|T00001&nbsp;|The name of the campaign.| |campaigns&nbsp;|campaignId&nbsp;|T00001&nbsp;|The identifier of the campaign.| |campaigns&nbsp;|campaignStatus&nbsp;|T00001&nbsp;|The status of the campaign.| |campaigns&nbsp;|currency&nbsp;|T00001&nbsp;|The currency code associated with the campaign.| |campaigns&nbsp;|impressions&nbsp;|T00001&nbsp;|Total number of ad impressions.| |campaigns&nbsp;|clicks&nbsp;|T00001&nbsp;|Total number of ad clicks associated with the campaign. Divide `clicks` by `impressions` to calculate click through rate (CTR).| |campaigns&nbsp;|cost&nbsp;|T00001&nbsp;|The total cost of all ad clicks for the campaign. Divide `cost` by `clicks` to calculate average cost per click (CPC).| |campaigns&nbsp;|attributedDPV14d&nbsp;|T00001&nbsp;|Number of attributed detail page views occurring within 14 days of click on an ad.| |campaigns&nbsp;|attributedUnitsSold14d&nbsp;|T00001&nbsp;|Number of attributed units sold occurring within 14 days of click on an ad.| |campaigns&nbsp;|attributedSales14d&nbsp;|T00001&nbsp;|Aggregate value of attributed sales occurring within 14 days of click on ad.|
     * @type {string}
     * @memberof ReportRequest
     */
    'metrics'?: string;
...
/**
 * Determines what the recommended bids will be optimized for. **Note that \"reach\" for bid optimization is not currently supported. This note will be removed when these operations become available.**  |Name|CostType|Supported Tactics|Description| |----|----------|-----------|-----------| |clicks|cpc|T00020 T00030|Optimize for page visits| |conversions|cpc|T00020 T00030|Optimize for conversion| |reach|vcpm|T00020 T00030|Optimize for viewable impressions. We recommend starting with $5 USD bids for each target to begin testing with this awareness strategy. $1 is the minimum bid for vCPM.|
 * @export
 * @enum {string}
 */
...
export const AdGroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        archiveAdGroup: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adGroupId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        createAdGroups: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, createAdGroup?: Array<CreateAdGroup>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getAdGroup: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adGroupId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getAdGroupResponseEx: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adGroupId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateAdGroups: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, updateAdGroup?: Array<UpdateAdGroup>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const AdGroupsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async archiveAdGroup(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adGroupId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AdGroupResponse>> {
         ...
         * @throws {RequiredError}
         */
        async createAdGroups(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, createAdGroup?: Array<CreateAdGroup>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AdGroupResponse>>> {
         ...
         * @throws {RequiredError}
         */
        async getAdGroup(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adGroupId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AdGroup>> {
         ...
         * @throws {RequiredError}
         */
        async getAdGroupResponseEx(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adGroupId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AdGroupResponseEx>> {
         ...
         * @throws {RequiredError}
         */
        async listAdGroups(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', campaignIdFilter?: string, adGroupIdFilter?: string, name?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AdGroup>>> {
         ...
         * @throws {RequiredError}
         */
        async listAdGroupsEx(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', campaignIdFilter?: string, adGroupIdFilter?: string, name?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AdGroupResponseEx>>> {
         ...
         * @throws {RequiredError}
         */
        async updateAdGroups(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, updateAdGroup?: Array<UpdateAdGroup>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AdGroupResponse>>> {
...
export class AdGroupsApi extends BaseAPI {
     ...
     */
    public archiveAdGroup(requestParameters: AdGroupsApiArchiveAdGroupRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof AdGroupsApi
     */
    public createAdGroups(requestParameters: AdGroupsApiCreateAdGroupsRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof AdGroupsApi
     */
    public getAdGroup(requestParameters: AdGroupsApiGetAdGroupRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof AdGroupsApi
     */
    public getAdGroupResponseEx(requestParameters: AdGroupsApiGetAdGroupResponseExRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof AdGroupsApi
     */
    public listAdGroups(requestParameters: AdGroupsApiListAdGroupsRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof AdGroupsApi
     */
    public listAdGroupsEx(requestParameters: AdGroupsApiListAdGroupsExRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof AdGroupsApi
     */
    public updateAdGroups(requestParameters: AdGroupsApiUpdateAdGroupsRequest, options?: AxiosRequestConfig) {
...
export const BidRecommendationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTargetBidRecommendations: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, sDTargetingBidRecommendationsRequestV32?: SDTargetingBidRecommendationsRequestV32, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const BidRecommendationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getTargetBidRecommendations(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, sDTargetingBidRecommendationsRequestV32?: SDTargetingBidRecommendationsRequestV32, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SDTargetingBidRecommendationsResponseV32>> {
...
export class BidRecommendationsApi extends BaseAPI {
     ...
     */
    public getTargetBidRecommendations(requestParameters: BidRecommendationsApiGetTargetBidRecommendationsRequest, options?: AxiosRequestConfig) {
...
export const BrandSafetyListOpenBetaApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createBrandSafetyDenyListDomains: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, brandSafetyPostRequest: BrandSafetyPostRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        deleteBrandSafetyDenyList: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getRequestResults: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, requestId: string, startIndex?: number, count?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getRequestStatus: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, requestId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listDomains: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listRequestStatus: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const BrandSafetyListOpenBetaApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createBrandSafetyDenyListDomains(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, brandSafetyPostRequest: BrandSafetyPostRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BrandSafetyUpdateResponse>> {
         ...
         * @throws {RequiredError}
         */
        async deleteBrandSafetyDenyList(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BrandSafetyUpdateResponse>> {
         ...
         * @throws {RequiredError}
         */
        async getRequestResults(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, requestId: string, startIndex?: number, count?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BrandSafetyRequestResultsResponse>> {
         ...
         * @throws {RequiredError}
         */
        async getRequestStatus(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, requestId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BrandSafetyRequestStatusResponse>> {
         ...
         * @throws {RequiredError}
         */
        async listDomains(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BrandSafetyGetResponse>> {
         ...
         * @throws {RequiredError}
         */
        async listRequestStatus(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BrandSafetyListRequestStatusResponse>> {
...
export class BrandSafetyListOpenBetaApi extends BaseAPI {
     ...
     */
    public createBrandSafetyDenyListDomains(requestParameters: BrandSafetyListOpenBetaApiCreateBrandSafetyDenyListDomainsRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof BrandSafetyListOpenBetaApi
     */
    public deleteBrandSafetyDenyList(requestParameters: BrandSafetyListOpenBetaApiDeleteBrandSafetyDenyListRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof BrandSafetyListOpenBetaApi
     */
    public getRequestResults(requestParameters: BrandSafetyListOpenBetaApiGetRequestResultsRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof BrandSafetyListOpenBetaApi
     */
    public getRequestStatus(requestParameters: BrandSafetyListOpenBetaApiGetRequestStatusRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof BrandSafetyListOpenBetaApi
     */
    public listDomains(requestParameters: BrandSafetyListOpenBetaApiListDomainsRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof BrandSafetyListOpenBetaApi
     */
    public listRequestStatus(requestParameters: BrandSafetyListOpenBetaApiListRequestStatusRequest, options?: AxiosRequestConfig) {
...
export const CampaignsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        archiveCampaign: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, campaignId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        createCampaigns: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, createCampaign?: Array<CreateCampaign>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getCampaign: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, campaignId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getCampaignResponseEx: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, campaignId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listCampaigns: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', name?: string, campaignIdFilter?: string, portfolioIdFilter?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateCampaigns: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, updateCampaign?: Array<UpdateCampaign>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const CampaignsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async archiveCampaign(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, campaignId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CampaignResponse>> {
         ...
         * @throws {RequiredError}
         */
        async createCampaigns(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, createCampaign?: Array<CreateCampaign>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CampaignResponse>>> {
         ...
         * @throws {RequiredError}
         */
        async getCampaign(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, campaignId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Campaign>> {
         ...
         * @throws {RequiredError}
         */
        async getCampaignResponseEx(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, campaignId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CampaignResponseEx>> {
         ...
         * @throws {RequiredError}
         */
        async listCampaigns(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', name?: string, campaignIdFilter?: string, portfolioIdFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Campaign>>> {
         ...
         * @throws {RequiredError}
         */
        async listCampaignsEx(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', name?: string, campaignIdFilter?: string, portfolioIdFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CampaignResponseEx>>> {
         ...
         * @throws {RequiredError}
         */
        async updateCampaigns(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, updateCampaign?: Array<UpdateCampaign>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CampaignResponse>>> {
...
export class CampaignsApi extends BaseAPI {
     ...
     */
    public archiveCampaign(requestParameters: CampaignsApiArchiveCampaignRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CampaignsApi
     */
    public createCampaigns(requestParameters: CampaignsApiCreateCampaignsRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CampaignsApi
     */
    public getCampaignResponseEx(requestParameters: CampaignsApiGetCampaignResponseExRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CampaignsApi
     */
    public listCampaignsEx(requestParameters: CampaignsApiListCampaignsExRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CampaignsApi
     */
    public updateCampaigns(requestParameters: CampaignsApiUpdateCampaignsRequest, options?: AxiosRequestConfig) {
...
export const CreativesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createCreatives: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, createCreative?: Array<CreateCreative>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listCreativeModerations: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, language: Locale, startIndex?: number, count?: number, adGroupIdFilter?: string, creativeIdFilter?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listCreatives: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, adGroupIdFilter?: string, creativeIdFilter?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        postCreativePreview: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, creativePreviewRequest?: CreativePreviewRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateCreatives: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, creativeUpdate?: Array<CreativeUpdate>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const CreativesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createCreatives(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, createCreative?: Array<CreateCreative>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CreativeResponse>>> {
         ...
         * @throws {RequiredError}
         */
        async listCreativeModerations(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, language: Locale, startIndex?: number, count?: number, adGroupIdFilter?: string, creativeIdFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CreativeModeration>>> {
         ...
         * @throws {RequiredError}
         */
        async listCreatives(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, adGroupIdFilter?: string, creativeIdFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Creative>>> {
         ...
         * @throws {RequiredError}
         */
        async postCreativePreview(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, creativePreviewRequest?: CreativePreviewRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreativePreviewResponse>> {
         ...
         * @throws {RequiredError}
         */
        async updateCreatives(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, creativeUpdate?: Array<CreativeUpdate>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CreativeResponse>>> {
...
export class CreativesApi extends BaseAPI {
     ...
     */
    public createCreatives(requestParameters: CreativesApiCreateCreativesRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CreativesApi
     */
    public listCreativeModerations(requestParameters: CreativesApiListCreativeModerationsRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CreativesApi
     */
    public listCreatives(requestParameters: CreativesApiListCreativesRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CreativesApi
     */
    public postCreativePreview(requestParameters: CreativesApiPostCreativePreviewRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof CreativesApi
     */
    public updateCreatives(requestParameters: CreativesApiUpdateCreativesRequest, options?: AxiosRequestConfig) {
...
export const NegativeTargetingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        archiveNegativeTargetingClause: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, negativeTargetId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        createNegativeTargetingClauses: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, createNegativeTargetingClause?: Array<CreateNegativeTargetingClause>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getNegativeTargets: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, negativeTargetId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getNegativeTargetsEx: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, negativeTargetId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listNegativeTargetingClauses: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', adGroupIdFilter?: string, campaignIdFilter?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateNegativeTargetingClauses: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, updateNegativeTargetingClause?: Array<UpdateNegativeTargetingClause>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const NegativeTargetingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async archiveNegativeTargetingClause(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, negativeTargetId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TargetResponse>> {
         ...
         * @throws {RequiredError}
         */
        async createNegativeTargetingClauses(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, createNegativeTargetingClause?: Array<CreateNegativeTargetingClause>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TargetResponse>>> {
         ...
         * @throws {RequiredError}
         */
        async getNegativeTargets(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, negativeTargetId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<NegativeTargetingClause>> {
         ...
         * @throws {RequiredError}
         */
        async getNegativeTargetsEx(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, negativeTargetId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<NegativeTargetingClauseEx>> {
         ...
         * @throws {RequiredError}
         */
        async listNegativeTargetingClauses(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', adGroupIdFilter?: string, campaignIdFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<NegativeTargetingClause>>> {
         ...
         * @throws {RequiredError}
         */
        async listNegativeTargetingClausesEx(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', targetIdFilter?: string, adGroupIdFilter?: string, campaignIdFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<NegativeTargetingClauseEx>>> {
         ...
         * @throws {RequiredError}
         */
        async updateNegativeTargetingClauses(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, updateNegativeTargetingClause?: Array<UpdateNegativeTargetingClause>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TargetResponse>>> {
...
export class NegativeTargetingApi extends BaseAPI {
     ...
     */
    public archiveNegativeTargetingClause(requestParameters: NegativeTargetingApiArchiveNegativeTargetingClauseRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof NegativeTargetingApi
     */
    public createNegativeTargetingClauses(requestParameters: NegativeTargetingApiCreateNegativeTargetingClausesRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof NegativeTargetingApi
     */
    public getNegativeTargets(requestParameters: NegativeTargetingApiGetNegativeTargetsRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof NegativeTargetingApi
     */
    public getNegativeTargetsEx(requestParameters: NegativeTargetingApiGetNegativeTargetsExRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof NegativeTargetingApi
     */
    public listNegativeTargetingClauses(requestParameters: NegativeTargetingApiListNegativeTargetingClausesRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof NegativeTargetingApi
     */
    public listNegativeTargetingClausesEx(requestParameters: NegativeTargetingApiListNegativeTargetingClausesExRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof NegativeTargetingApi
     */
    public updateNegativeTargetingClauses(requestParameters: NegativeTargetingApiUpdateNegativeTargetingClausesRequest, options?: AxiosRequestConfig) {
...
export const ProductAdsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        archiveProductAd: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        createProductAds: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, createProductAd?: Array<CreateProductAd>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getProductAd: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getProductAdResponseEx: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listProductAds: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', adIdFilter?: string, adGroupIdFilter?: string, campaignIdFilter?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateProductAds: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, updateProductAd?: Array<UpdateProductAd>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const ProductAdsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async archiveProductAd(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductAdResponse>> {
         ...
         * @throws {RequiredError}
         */
        async createProductAds(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, createProductAd?: Array<CreateProductAd>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProductAdResponse>>> {
         ...
         * @throws {RequiredError}
         */
        async getProductAd(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductAd>> {
         ...
         * @throws {RequiredError}
         */
        async getProductAdResponseEx(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, adId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductAdResponseEx>> {
         ...
         * @throws {RequiredError}
         */
        async listProductAds(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', adIdFilter?: string, adGroupIdFilter?: string, campaignIdFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProductAd>>> {
         ...
         * @throws {RequiredError}
         */
        async listProductAdsEx(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', adIdFilter?: string, adGroupIdFilter?: string, campaignIdFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProductAdResponseEx>>> {
         ...
         * @throws {RequiredError}
         */
        async updateProductAds(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, updateProductAd?: Array<UpdateProductAd>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProductAdResponse>>> {
...
export class ProductAdsApi extends BaseAPI {
     ...
     */
    public archiveProductAd(requestParameters: ProductAdsApiArchiveProductAdRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ProductAdsApi
     */
    public createProductAds(requestParameters: ProductAdsApiCreateProductAdsRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ProductAdsApi
     */
    public getProductAd(requestParameters: ProductAdsApiGetProductAdRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ProductAdsApi
     */
    public getProductAdResponseEx(requestParameters: ProductAdsApiGetProductAdResponseExRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ProductAdsApi
     */
    public listProductAds(requestParameters: ProductAdsApiListProductAdsRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ProductAdsApi
     */
    public listProductAdsEx(requestParameters: ProductAdsApiListProductAdsExRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ProductAdsApi
     */
    public updateProductAds(requestParameters: ProductAdsApiUpdateProductAdsRequest, options?: AxiosRequestConfig) {
...
export const ReportsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        downloadReport: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, reportId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getReportStatus: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, reportId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @param {string} amazonAdvertisingAPIClientId The identifier of a client associated with a \&quot;Login with Amazon\&quot; account.
         * @param {string} amazonAdvertisingAPIScope The identifier of a profile associated with the advertiser account. Use &#x60;GET&#x60; method on Profiles resource to list profiles associated with the access token passed in the HTTP Authorization header.
         * @param {'campaigns' | 'adGroups' | 'productAds' | 'targets' | 'asins'} recordType The type of report to generate, either &#x60;campaigns&#x60;, &#x60;adGroups&#x60;, &#x60;productAds&#x60;, &#x60;targets&#x60;, or &#x60;asins&#x60;.
         * @param {ReportRequest} [reportRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        requestReport: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, recordType: 'campaigns' | 'adGroups' | 'productAds' | 'targets' | 'asins', reportRequest?: ReportRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const ReportsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async downloadReport(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, reportId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getReportStatus(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, reportId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReportResponse>> {
         ...
         * @throws {RequiredError}
         */
        async requestReport(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, recordType: 'campaigns' | 'adGroups' | 'productAds' | 'targets' | 'asins', reportRequest?: ReportRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReportResponse>> {
...
export interface ReportsApiRequestReportRequest {
    ...
    /**
     * The type of report to generate, either &#x60;campaigns&#x60;, &#x60;adGroups&#x60;, &#x60;productAds&#x60;, &#x60;targets&#x60;, or &#x60;asins&#x60;.
...
export class ReportsApi extends BaseAPI {
     ...
     * @memberof ReportsApi
     */
    public downloadReport(requestParameters: ReportsApiDownloadReportRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ReportsApi
     */
    public getReportStatus(requestParameters: ReportsApiGetReportStatusRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ReportsApi
     */
    public requestReport(requestParameters: ReportsApiRequestReportRequest, options?: AxiosRequestConfig) {
...
export const SnapshotsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createSnapshot: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, recordType: string, snapshotRequest?: SnapshotRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        downloadSnapshot: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, snapshotId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getSnapshot: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, snapshotId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const SnapshotsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createSnapshot(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, recordType: string, snapshotRequest?: SnapshotRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SnapshotResponse>> {
         ...
         * @throws {RequiredError}
         */
        async downloadSnapshot(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, snapshotId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getSnapshot(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, snapshotId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SnapshotResponse>> {
...
export class SnapshotsApi extends BaseAPI {
     ...
     */
    public createSnapshot(requestParameters: SnapshotsApiCreateSnapshotRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof SnapshotsApi
     */
    public downloadSnapshot(requestParameters: SnapshotsApiDownloadSnapshotRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof SnapshotsApi
     */
    public getSnapshot(requestParameters: SnapshotsApiGetSnapshotRequest, options?: AxiosRequestConfig) {
...
export const TargetingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        archiveTargetingClause: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, targetId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getTargets: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, targetId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getTargetsEx: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, targetId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateTargetingClauses: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, updateTargetingClause?: Array<UpdateTargetingClause>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const TargetingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async archiveTargetingClause(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, targetId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TargetResponse>> {
         ...
         * @throws {RequiredError}
         */
        async createTargetingClauses(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, createTargetingClause?: Array<CreateTargetingClause>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TargetResponse>>> {
         ...
         * @throws {RequiredError}
         */
        async getTargets(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, targetId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TargetingClause>> {
         ...
         * @throws {RequiredError}
         */
        async getTargetsEx(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, targetId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TargetingClauseEx>> {
         ...
         * @throws {RequiredError}
         */
        async listTargetingClauses(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', adGroupIdFilter?: string, campaignIdFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TargetingClause>>> {
         ...
         * @throws {RequiredError}
         */
        async listTargetingClausesEx(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, startIndex?: number, count?: number, stateFilter?: 'enabled' | 'paused' | 'archived' | 'enabled, paused' | 'enabled, archived' | 'paused, archived' | 'enabled, paused, archived', targetIdFilter?: string, adGroupIdFilter?: string, campaignIdFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TargetingClauseEx>>> {
         ...
         * @throws {RequiredError}
         */
        async updateTargetingClauses(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, updateTargetingClause?: Array<UpdateTargetingClause>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TargetResponse>>> {
...
export interface TargetingApiCreateTargetingClausesRequest {
    ...
    /**
     * A list of up to 100 targeting clauses for creation.
...
export class TargetingApi extends BaseAPI {
     ...
     */
    public archiveTargetingClause(requestParameters: TargetingApiArchiveTargetingClauseRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof TargetingApi
     */
    public createTargetingClauses(requestParameters: TargetingApiCreateTargetingClausesRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof TargetingApi
     */
    public getTargets(requestParameters: TargetingApiGetTargetsRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof TargetingApi
     */
    public getTargetsEx(requestParameters: TargetingApiGetTargetsExRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof TargetingApi
     */
    public listTargetingClauses(requestParameters: TargetingApiListTargetingClausesRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof TargetingApi
     */
    public listTargetingClausesEx(requestParameters: TargetingApiListTargetingClausesExRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof TargetingApi
     */
    public updateTargetingClauses(requestParameters: TargetingApiUpdateTargetingClausesRequest, options?: AxiosRequestConfig) {
...
export const TargetingRecommendationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTargetRecommendations: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, sDTargetingRecommendationsRequestV31?: SDTargetingRecommendationsRequestV31, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const TargetingRecommendationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getTargetRecommendations(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, sDTargetingRecommendationsRequestV31?: SDTargetingRecommendationsRequestV31, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SDTargetingRecommendationsResponseV31>> {
...
export class TargetingRecommendationsApi extends BaseAPI {
     ...
     */
    public getTargetRecommendations(requestParameters: TargetingRecommendationsApiGetTargetRecommendationsRequest, options?: AxiosRequestConfig) {
