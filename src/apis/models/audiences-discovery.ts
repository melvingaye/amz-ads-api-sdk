...
export const DiscoveryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        fetchTaxonomy: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, fetchTaxonomyRequestBodyV1: FetchTaxonomyRequestBodyV1, advertiserId?: string, nextToken?: string, maxResults?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        listAudiences: async (amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, advertiserId?: string, nextToken?: string, maxResults?: number, listAudiencesRequestBodyV1?: ListAudiencesRequestBodyV1, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const DiscoveryApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async fetchTaxonomy(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, fetchTaxonomyRequestBodyV1: FetchTaxonomyRequestBodyV1, advertiserId?: string, nextToken?: string, maxResults?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchTaxonomyResponseV1>> {
         ...
         * @throws {RequiredError}
         */
        async listAudiences(amazonAdvertisingAPIClientId: string, amazonAdvertisingAPIScope: string, advertiserId?: string, nextToken?: string, maxResults?: number, listAudiencesRequestBodyV1?: ListAudiencesRequestBodyV1, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListAudiencesResponseV1>> {
...
export class DiscoveryApi extends BaseAPI {
     ...
     */
    public fetchTaxonomy(requestParameters: DiscoveryApiFetchTaxonomyRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof DiscoveryApi
     */
    public listAudiences(requestParameters: DiscoveryApiListAudiencesRequest, options?: AxiosRequestConfig) {
