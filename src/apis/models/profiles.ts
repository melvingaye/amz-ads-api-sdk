 ...
 * Profiles represent an advertiser and their account\'s marketplace, and are used in all subsequent API calls via a management scope, `Amazon-Advertising-API-Scope`. Reports and all entity management operations are associated with a single profile. Advertisers cannot have more than one profile for each marketplace.  Advertisers who operate in more than one marketplace (for example, Amazon.com, Amazon.co.uk, Amazon.co.jp) will have only one profile associated with each marketplace. [See this link](https://advertising.amazon.com/API/docs/en-us/get-started/how-to-use-api#API_Endpoints) for a list of marketplaces associated with each endpoint.  Use the returned `profileId` as the value for the management scope (`Amazon-Advertising-API-Scope`) in the headers for subsequent API calls (e.g. campaigns, adgroups, ads, ...). To retrieve your profile ids, call the listProfiles operation, and include a valid authorization access token in the header.
 *
...
export const ProfilesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getProfileById: async (amazonAdvertisingAPIClientId: string, profileId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        listProfiles: async (amazonAdvertisingAPIClientId: string, apiProgram?: 'billing' | 'campaign' | 'paymentMethod' | 'store' | 'report' | 'account' | 'posts', accessLevel?: 'edit' | 'view', profileTypeFilter?: 'seller' | 'vendor' | 'agency', validPaymentMethodFilter?: 'true' | 'false', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @param {string} amazonAdvertisingAPIClientId The identifier of a client associated with a \&quot;Login with Amazon\&quot; account.
         * @param {Array<RegisterSellerProfileRequest>} [registerSellerProfileRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        registerSandboxSeller: async (amazonAdvertisingAPIClientId: string, registerSellerProfileRequest?: Array<RegisterSellerProfileRequest>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @param {string} amazonAdvertisingAPIClientId The identifier of a client associated with a \&quot;Login with Amazon\&quot; account.
         * @param {Array<RegisterVendorProfileRequest>} [registerVendorProfileRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        registerSandboxVendor: async (amazonAdvertisingAPIClientId: string, registerVendorProfileRequest?: Array<RegisterVendorProfileRequest>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateProfiles: async (amazonAdvertisingAPIClientId: string, profile?: Array<Profile>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'amazonAdvertisingAPIClientId' is not null or undefined
...
export const ProfilesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getProfileById(amazonAdvertisingAPIClientId: string, profileId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Profile>> {
         ...
         * @throws {RequiredError}
         */
        async registerSandboxSeller(amazonAdvertisingAPIClientId: string, registerSellerProfileRequest?: Array<RegisterSellerProfileRequest>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RegisterSellerProfileResponse>>> {
         ...
         * @throws {RequiredError}
         */
        async registerSandboxVendor(amazonAdvertisingAPIClientId: string, registerVendorProfileRequest?: Array<RegisterVendorProfileRequest>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RegisterVendorProfileResponse>>> {
         ...
         * @throws {RequiredError}
         */
        async updateProfiles(amazonAdvertisingAPIClientId: string, profile?: Array<Profile>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ProfileResponse>>> {
...
export const ProfilesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        registerSandboxSeller(amazonAdvertisingAPIClientId: string, registerSellerProfileRequest?: Array<RegisterSellerProfileRequest>, options?: any): AxiosPromise<Array<RegisterSellerProfileResponse>> {
         ...
         * @throws {RequiredError}
         */
        registerSandboxVendor(amazonAdvertisingAPIClientId: string, registerVendorProfileRequest?: Array<RegisterVendorProfileRequest>, options?: any): AxiosPromise<Array<RegisterVendorProfileResponse>> {
...
export interface ProfilesApiRegisterSandboxSellerRequest {
    ...
    /**
     * 
     * @type {Array<RegisterSellerProfileRequest>}
     * @memberof ProfilesApiRegisterSandboxSeller
     */
    readonly registerSellerProfileRequest?: Array<RegisterSellerProfileRequest>
}
...
export interface ProfilesApiRegisterSandboxVendorRequest {
    ...
    /**
     * 
     * @type {Array<RegisterVendorProfileRequest>}
     * @memberof ProfilesApiRegisterSandboxVendor
     */
    readonly registerVendorProfileRequest?: Array<RegisterVendorProfileRequest>
}
...
export class ProfilesApi extends BaseAPI {
     ...
     */
    public getProfileById(requestParameters: ProfilesApiGetProfileByIdRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ProfilesApi
     */
    public listProfiles(requestParameters: ProfilesApiListProfilesRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ProfilesApi
     */
    public registerSandboxSeller(requestParameters: ProfilesApiRegisterSandboxSellerRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ProfilesApi
     */
    public registerSandboxVendor(requestParameters: ProfilesApiRegisterSandboxVendorRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof ProfilesApi
     */
    public updateProfiles(requestParameters: ProfilesApiUpdateProfilesRequest, options?: AxiosRequestConfig) {
